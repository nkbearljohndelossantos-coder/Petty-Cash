...
const commands = [
  ...
  `cp -v ${TEMP}/backend/src/db/migrations/20260618000000_fix_reminder_audit_and_tracking.js ${NODEJS}/src/db/migrations/20260618000000_fix_reminder_audit_and_tracking.js`,

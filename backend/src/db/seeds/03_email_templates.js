  ...
  await knex('email_templates').insert([
    {
      ...
      subject: '{{title}} — NKB Petty Cash',
      body: `
        <div style="font-family: sans-serif; padding: 20px; color: #333;">
          <h2 style="color: #d97706;">{{title}}</h2>
          <p>Hi {{fullName}},</p>
          <p>{{message}}</p>
          <a href="{{link}}" style="display: inline-block; padding: 12px 24px; background: #2563eb; color: #fff; text-decoration: none; border-radius: 8px; font-weight: bold;">Open in System</a>
          <p style="margin-top: 20px; font-size: 12px; color: #64748b;">This is an automated notification from NKB Manufacturing Petty Cash System.</p>
        </div>
      `,
      type: 'approval'
    },
